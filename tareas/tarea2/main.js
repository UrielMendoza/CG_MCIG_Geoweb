document.addEventListener('DOMContentLoaded', function () {
    ...
    var puntos = [
        { lat: cdmx.lat, lng: cdmx.lng, desc: 'Ciudad de México' },
        { lat: merida.lat, lng: merida.lng, desc: 'Mérida' },
        { lat: aguascalientes.lat, lng: aguascalientes.lng, desc: 'Aguascalientes' },
        { lat: queretaro.lat, lng: queretaro.lng, desc: 'Querétaro' }
    ];
